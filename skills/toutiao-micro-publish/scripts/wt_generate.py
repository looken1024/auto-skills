...
- 【数据迭代 2026-09-14 · 硬性】首句必须是「具体事件+数字/金额/人物/已发生动作」，禁止以"很多人觉得/大家/说实话/最近"等泛群体视角开头。实测（后台真实展现数据）：故事型首句展现 813-1659，泛议题首句只有 26-86。写完自检首句：不含具体数字/人物/事件 → 重写开头
- 结尾抛一个问题，或给一条能马上用的建议
...
【数据迭代 2026-09-14 · 硬性】同等条件下优先选**有具体当事人/金额/判决/合同的具体事件类**题目；纯趋势/观点/政策解读类（如"XX将成主流""XX的三重信号"）降权——实测具体事件类平均展现 1200+，泛议题类 <100。若只能选政策/趋势类，angle 必须落到"具体人的具体遭遇"场景（写看病就写某个病人在A医院重拍CT，不写政策条文）。
